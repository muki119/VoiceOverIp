 ...
 * <p>
 * channel.SecurityLayer class implement the security layer functionality
 * <p>
 * Author: Sibtain Syed and Jay Groom
 */
public class SecurityLayer {
    public static final int KEY = 1357;
    //To test authentication change this key on receiver side
    ...
    public byte[] encryptAndAddAuthenticationToken(byte[] data) {
        ...
        // Debugging output
        //System.out.println("channel.SecurityLayer: Packet encrypted and authentication token added");
    ...
    public byte[] decryptReceivePacket(byte[] receivePacket) throws Exception {
        ...
        if (encryptedBlock != null) {
            ...
            // Debugging Output
            // System.out.println("channel.SecurityLayer: Packet decrypted successfully.");

            return packet.array();
        }

        // If authentication fails, return null
        System.out.println("channel.SecurityLayer: Packet authentication failed.");
        return null;
    }
