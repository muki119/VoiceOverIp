 ...
 * <p>
 * ConnectionDS2 class that will use DatagramSocket2 for UDP packet transmission.
 * It uses static key for encryption
 * <p>
 * Author: Sibtain Syed
 */

public class ConnectionDS2 {
    ...
    public ConnectionDS2(String ip, int port) {
        try {
            this.ip = InetAddress.getByName(ip);
            this.port = port;
            this.portToBind = port;
            this.socket = new DatagramSocket2();
    ...
    public ConnectionDS2(String ip, int port, int portToBind) {
        this(ip, port);
    ...
    public ConnectionDS2 listen(Consumer<byte[]> callback) { // for listening to incoming audio
        try {
            this.socket = new DatagramSocket2(this.portToBind);
